...
syms mv pv;
hold on
n1 = fimplicit(@(pv,mv)  pv.*mv.*Q./(pv/d+mv) - mup.*pv^2, [0,pmax],'Color', [0.6 0.3 0],'Linestyle','--','Linewidth',2);
hold on
...
y10 = 0.1;
x10 = 0.2;
[ts,ys] = ode45(@basic_eq,0:0.1:1000,[x10;y10]);
...
[T,Y] = ode45(@basic_eq,0:0.1:1000,[x10;y10]);
